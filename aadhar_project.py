...
code = conn=mysql.connector.connect(host='localhost',user="root",password="Password@123",database="dl_project")  
mycursor=conn.cursor()

mycursor.execute("SELECT pic FROM aadhar")
...
mycursor.execute("SELECT name FROM aadhar")
        ...
        if text_input not in class_name:
            ...
            if option == 'YES':
              ...
              if uploaded_file is not None:
                    ...
                    conn=mysql.connector.connect(host='localhost',user="root",password="Password@123",database="dl_project")  
                    mycursor=conn.cursor()

                    sql = "INSERT INTO aadhar(id,Name,Pic) VALUES(%s,%s,%s)"
